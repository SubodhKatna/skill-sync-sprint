...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleValidation(MethodArgumentNotValidException ex, HttpServletRequest request) {
        ...
        return buildError(HttpStatus.BAD_REQUEST, "VALIDATION_ERROR",
                "Validation failed for " + validationErrors.size() + " field(s)", request, validationErrors);
    }
    ...
    public ResponseEntity<ErrorResponse> handleConstraintViolation(ConstraintViolationException ex, HttpServletRequest request) {
        ...
        return buildError(HttpStatus.BAD_REQUEST, "CONSTRAINT_VIOLATION",
                "Constraint violation for " + validationErrors.size() + " value(s)", request, validationErrors);
    }
    ...
    private ErrorResponse.ValidationError toValidationError(FieldError fieldError) {
        return new ErrorResponse.ValidationError(fieldError.getField(), fieldError.getDefaultMessage(), fieldError.getRejectedValue());
    }
